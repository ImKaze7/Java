	...
	void VenderCeramico() {
		...
		canti1 = Integer.parseInt(txtCanti.getText());
		 ...
		 if(canti1 >= 1 && canti1 <=5){	
			 des=ic1*(porcentaje1/100);
			 }
		 
		 if(canti1 >=6 && canti1 <=10) { 
			des=ic1*(porcentaje2/100);
			}
		 
		 if (canti1 >=11  && canti1 <=15) {
			des=ic1*(porcentaje3/100);
			}else if (canti1 >15) {
			des=ic1*(porcentaje4/100);
			}
		...
		canti2 = Integer.parseInt(txtCanti.getText());
			...
			if(canti2 >= 1 && canti2 <=5){	
				 des=ic2*(porcentaje1/100);
				 }
			 
			 if(canti2 >=6 && canti2 <=10) { 
				des=ic2*(porcentaje2/100);
				}
			 
			 if (canti2 >=11  && canti2 <=15) {
				des=ic2*(porcentaje3/100);
				}else if (canti2 >15) {
				des=ic2*(porcentaje4/100);
				}
			 ip=ic2-des;	 tot3+=ip;
				//Acumula EL importe a pagar
		...
		canti3 = Integer.parseInt(txtCanti.getText());
			...
			if(canti3 >= 1 && canti3 <=5){	
				 des=ic3*(porcentaje1/100);
				 }
			 
			 if(canti3 >=6 && canti3 <=10) { 
				des=ic3*(porcentaje2/100);
				}
			 
			 if (canti3 >=11  && canti3 <=15) {
				des=ic3*(porcentaje3/100);
				}else if (canti3 >15) {
				des=ic3*(porcentaje4/100);
				}
			 ip=ic3-des;	 tot4+=ip;
				//Acumula EL importe a pagar
		...
		canti4 = Integer.parseInt(txtCanti.getText());
			...
			if(canti4 >= 1 && canti4 <=5){	
				 des=ic4*(porcentaje1/100);
				 }
			 
			 if(canti4 >=6 && canti4 <=10) { 
				des=ic4*(porcentaje2/100);
				}
			 
			 if (canti4 >=11  && canti4 <=15) {
				des=ic4*(porcentaje3/100);
				}else if (canti4 >15) {
				des=ic4*(porcentaje4/100);
				}
			 ip=ic4-des;	 tot5+=ip;
				//Acumula EL importe a pagar
